...
<!-- Rscript --vanilla -e 'rmarkdown::render(input = "R_markdown/Analysis_of_several_stanfits_experimental_data_eGFP_ODE.Rmd", -->
<!-- output_file = "pdf_files/Analysis_of_several_stanfits_experimental_data_eGFP_ODE.pdf", -->
...
## Trajectory `r index_trajectory`: very high Rhat for theta[1]  theta[3] 
...
index_trajectory <- 42
```
## Trajectory `r index_trajectory`: very high Rhat for  sigma  offset  t0  prod_theta2_m0_scale
