...
prod_theta2_m0_scale <- 350


##----- parameter setting 1 -----------------------------------------------------------
theta2_1 <- 0.1 # translation rate constant
m0_1 <- 200 # initial amount of mRNA
scale_1 <- prod_theta2_m0_scale / (theta2_1 * m0_1) # scaling factor for the fluorescence

# initial conditions for mRNA, GFP
initial <- c(m0_1, 0)
# parameters:
pars1 <- list(theta = c(0.11, theta2_1, 0.03), m0 = m0_1, t0 = t0, 
...
# parameters:
pars2 <- list(theta = c(0.11, theta2_2, 0.03), m0 = m0_2, t0 = t0, 
...
# parameters:
pars3 <- list(theta = c(0.11, theta2_3, 0.03), m0 = m0_3, t0 = t0, 
...
# parameters:
pars4 <- list(theta = c(0.11, theta2_4, 0.03), m0 = m0_4, t0 = t0, 
...
# parameters:
pars5 <- list(theta = c(0.11, theta2_5, 0.03), m0 = m0_5, t0 = t0, 
...
# parameters:
pars6 <- list(theta = c(0.11, theta2_6, 0.03), m0 = m0_6, t0 = t0, 
...
if(save_plots){
  pdf("figures_and_tables/Fig_study_identifiability_keep_prod_theta2_m0_scale_constant.pdf", width = 7.5, height = 5)
}
...
h <- 2
v <- 600
legend(x = 10+h, y = 50+v, bty = "n", legend = c("ODE solution", "SDE trajectories"),
       col = c(1, plot_color[3]), lty = c(1,1), lwd = c(2,1))
legend(x = 10+h, y = 100+v, bty = "n", legend = c("", ""), col = c(0, plot_color[2]), lty = c(1,1))
legend(x = 10+h, y = 0+v, bty = "n", legend = c("", ""), col = c(0, plot_color[7]), lty = c(1,1))
legend(x = 10+h, y = -50+v, bty = "n", legend = c("", ""), col = c(0, plot_color[6]), lty = c(1,1))
...
##----- parameter setting 7 -----------------------------------------------------------
# parameters:
pars7 <- list(theta = c(0.03, theta2_1, 0.11), m0 = m0_1, t0 = t0, 
              scale = scale_1, offset = offset)
...
if(save_plots){
  pdf("figures_and_tables/Fig_study_identifiability_swap_theta1_theta3_several_trajectories.pdf", width = 7, height = 3.5)
}
...
h <- -1
v <- 600
legend(x = 10+h, y = 150+v, bty = "n", legend = c("ODE solution", "SDE trajectories"),
       col = c(1, plot_color[3]), lty = c(1,1), lwd = c(2,1))
legend(x = 10+h, y = 200+v, bty = "n", legend = c("", ""), col = c(0, plot_color[2]), lty = c(1,1))
legend(x = 10+h, y = 100+v, bty = "n", legend = c("", ""), col = c(0, plot_color[7]), lty = c(1,1))
legend(x = 10+h, y = 50+v, bty = "n", legend = c("", ""), col = c(0, plot_color[6]), lty = c(1,1))
...
if(save_plots){
  pdf("figures_and_tables/Fig_study_identifiability_swap_theta1_theta3_individual_trajectories.pdf", width = 7.5, height = 4.75)
}
