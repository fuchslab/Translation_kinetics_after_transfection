...
dataset <- "experimental_data_d2eGFP"
obs_index <- 6
...
if(save_results){
  ODE_table <- print(xtable::xtable(stan_summary_ODE, digits = digits,
                     ...
                     booktabs = TRUE,
                     file = "figures_and_tables/tab_exper_data_d2eGFP_ODE_summary.txt")
  ODE_table <- readLines("figures_and_tables/tab_exper_data_d2eGFP_ODE_summary.txt")
  writeLines(ODE_table[5:(length(ODE_table)-1)], 
             con = "figures_and_tables/tab_exper_data_d2eGFP_ODE_summary.txt" )
...
if(save_results){
  SDE_table <- print(xtable::xtable(stan_summary_SDE, digits = digits,
                     ...
                     sanitize.text.function=function(x){x},
                     booktabs = TRUE,
                     file = "figures_and_tables/tab_exper_data_d2eGFP_SDE_summary.txt")
  SDE_table <- readLines("figures_and_tables/tab_exper_data_d2eGFP_SDE_summary.txt")
  writeLines(SDE_table[5:(length(SDE_table)-1)], 
             con = "figures_and_tables/tab_exper_data_d2eGFP_SDE_summary.txt" )
}else{
...
if(save_results){
  if(fig_format == "pdf"){
    pdf("figures_and_tables/Fig_pairs_exper_data_d2eGFP_theta_1_3_offset_sigma.pdf", 
        width = 6, height = 5.3)
  }else if(fig_format == "png"){
    png("figures_and_tables/Fig_pairs_exper_data_d2eGFP_theta_1_3_offset_sigma.png", 
        width = 900, height = 800, pointsize = 24)
  }
}
...
if(save_results){
  pdf("figures_and_tables/Fig_pairs_exper_data_d2eGFP_theta_2_m0_scale.pdf", 
      width = 6.35, height = 5.6)
}else if(fig_format == "png"){
  png("figures_and_tables/Fig_pairs_exper_data_d2eGFP_theta_2_m0_scale.png", 
...
if(save_results){
  if(fig_format == "pdf"){
    pdf("figures_and_tables/Fig_pairs_exper_data_d2eGFP_theta_2_m0_scale_all.pdf", 
        width = 10, height = 9.4)
  }else if(fig_format == "png"){
    png("figures_and_tables/Fig_pairs_exper_data_d2eGFP_theta_2_m0_scale_all.png", 
...
if(save_results){
  # pdf("figures_and_tables/Fig_pairs_exper_data_d2eGFP_all_param.pdf", 
  #     width = 15, height = 14.1)
  png("figures_and_tables/Fig_pairs_exper_data_d2eGFP_all_param.png", 
...
if(save_results){
  # pdf("figures_and_tables/Fig_pairs_exper_data_d2eGFP_all_param_SDE.pdf", 
  #       width = 15, height = 14.1)
  png("figures_and_tables/Fig_pairs_exper_data_d2eGFP_all_param_SDE.png", 
      width = 2400, height = 2300, pointsize = 28)
}
param <- c("theta[1]", "theta[3]", "offset", "sigma",
           "theta[2]", "m0", "scale",
...
if(save_results){
  # pdf("figures_and_tables/Fig_pairs_exper_data_d2eGFP_all_param_ODE.pdf", 
  #     width = 15, height = 14.1)
  png("figures_and_tables/Fig_pairs_exper_data_d2eGFP_all_param_ODE.png", 
      width = 2400, height = 2300, pointsize = 28)
}
param <- c("theta[1]", "theta[3]", "offset", "sigma", 
           "theta[2]", "m0", "scale",
...
if(save_results){
  file_name <- "figures_and_tables/tab_exper_data_d2eGFP_CI_lengths.txt"
...
if(save_results){
  ggsave("figures_and_tables/Fig_traceplots_exper_data_d2eGFP.pdf", plot = p,
         width = 8, height = 9)
}else{
  p
}
